var AUTOCOMPLETE = ((global, $)=>{
  "use strict";
    ...
    function buildDocumentation(){
        for(let name of Object.keys(PARSED_AUTOCOMPLETIONS.children)){
            let child = PARSED_AUTOCOMPLETIONS.children[name]
    ...
    function printNode(container, node, name, topNode){
        ...
        if(node.lib){
            top.append(
                $('<div class="lib">' + AUTOCOMPLETE.LIB_TITLES[node.lib] + '</div>')
            )
        }
